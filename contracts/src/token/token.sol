...
contract AIInterface is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address defaultAdmin, address pauser, address recipient, address upgrader)
        public initializer
    {
        __ERC20_init("AI Interface", "AII");
        __ERC20Burnable_init();
        __ERC20Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("AI Interface");
        __ERC20Votes_init();
